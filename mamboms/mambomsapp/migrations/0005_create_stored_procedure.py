...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        print "==========================================================================================="
        print
        print "At this point you need to create the stored procedure 'search_by_spectra'"
        print "This migration cannot do it for you - manual intervention is required."
        print "1. plpython needs to be installed for postgres"
        print "2. The language needs to have been created for this database (CREATE LANGUAGE plpythonu)"
        print "   by a superuser."
        print "3. The script spectra_search_storedproc.sql needs to be run on this database by a superuser"
        print
        print "==========================================================================================="
        print
