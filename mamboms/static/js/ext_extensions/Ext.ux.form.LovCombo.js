...
Ext.ux.form.LovCombo = Ext.extend(Ext.form.ComboBox, {
    ...
    /*BP: adding this function to prevent combo losing displayed value when changing focus
    // as per workaround here: 
    // http://www.sencha.com/forum/showthread.php?32692-Stable-1.0-LovCombo-Simple-List-of-Values-Combo/page56
    */
    ,beforeBlur: function() {
	...
	,onRealBlur:function() {
		...
		Ext.each(rva, function(v) {
			snapshot.each(function(r) {
                /*BP: changed === to == as per workaround here: 
                    http://www.sencha.com/forum/showthread.php?32692-Stable-1.0-LovCombo-Simple-List-of-Values-Combo/page56
				*/
